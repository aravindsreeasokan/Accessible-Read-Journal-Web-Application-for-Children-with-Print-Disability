...
function generateBookReview($bookTitle,$authorname) {
    ...
    $apiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=" . $apiKey;// Replace this with your prompt
...
echo generateBookReview($bookTitle,$authorname); // Function call
