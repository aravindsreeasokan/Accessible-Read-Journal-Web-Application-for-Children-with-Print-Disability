...
function grid($serialno, $name, $image, $category, $language)
{
    $element = "
        <div class='card'>
            <form method='POST' action='question_table.php'>
                ...
                <div id='request'>
                    ...
                    <button type='submit' id='rentbook' class='add' name='rent'>Attend Exam</button>
                </div>
            </form>
        </div>";
    echo $element;
